...
public class GetAwayStocksSold extends javax.swing.JFrame {

    public GetAwayStocksSold() {
        initComponents();
    }
    public GetAwayStocksSold(String a, String b) {
        initComponents();
        lbl_pname.setText(a);
        lbl_pt.setText(b);
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_order, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        {
            JOptionPane.showMessageDialog(null, "Input Product Sold First!");
        }
        else
        {
            class_product.Sold_Product(lbl_pname.getText(), lbl_pt.getText(), txt_order.getText());
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetAwayStocksSold().setVisible(true);
            }
        });
    }
